...
func (c *roomInternalServiceClient) VerifyRoomMember(ctx context.Context, request *VerifyRoomMemberRequest, opts ...grpc.CallOption) (*VerifyRoomMemberResponse, error) {
	response := new(VerifyRoomMemberResponse)
	opts = append(opts, grpc.CallContentSubtype("json"))
	if err := c.cc.Invoke(ctx, "/worktogether.room.v1.RoomInternalService/VerifyRoomMember", request, response, opts...); err != nil {
		return nil, err
	}
	return response, nil
}
