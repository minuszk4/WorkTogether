...
export class ApiService {
  ...
  public room = {
    ...
    listEvents: (roomId: string): Observable<any[]> =>
      this.get<any[]>(`/rooms/${roomId}/events`),
  ...
  public admin = {
    ...
    listRoomMembers: (roomId: string): Observable<any[]> => this.get<any[]>(`/admin/rooms/${roomId}/members`),
